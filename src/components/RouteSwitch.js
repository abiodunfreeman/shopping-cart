...
const RouteSwitch = () => {
    ...
    function handleAddItemToCart( item ){
        const itemToFind = cart.find(object => { //looks for item in cart
            return object.name === item.name
        })
        if (itemToFind === undefined) { //if item is not in cart already, adds a new object
        ...
        } else if (itemToFind) { //if item is not in the cart yet
